...
class SignUpController extends Controller
{
    public function login(Request $request) {
        ...
        try {
            ...
            if (!empty($request->device_token)) {
                ...
                //Helper::send_mail('tech@groomit.me', '[groomit][LoginSignUpControllerLogin] user device token is empty upon login', $user->email);
            }
    ...
    public function login_3rd_party(Request $request) {
        ...
        try {
            ...
            if (!empty($request->device_token)) {
                ...
                //Helper::send_mail('tech@groomit.me', '[groomit][LoginSignUpControllerLogin_3rd_party] user device token is empty upon login 3rd party', $user->email);
            }
    ...
    public function signup_user(Request $request) { // Not used any longer, called from /login/signup_user
        ...
        try {
            ...
            $user->device_token = $request->device_token;
            if (empty($request->device_token)) {
                //Helper::send_mail('tech@groomit.me', '[groomit][LoginSignUpControllerSignup_user] user device token is empty upon signup', $user->email);
            }
