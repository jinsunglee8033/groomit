...
@section('content')
<section id="GroomitBannerClean" class="bannerPricingMiami" title="In-Home pet grooming"> <!-- #banner starts -->
</section> <!-- #banner ends -->
        ...
        <div class="row row-same-height mb-3">
            <div class="col-lg-6 top col-sm-6 col-sm-push-6 col-sm-push-6 relative-pos same-h-col mb-5">
                <ul class="flex-container space-between mb-5">
                    <li class="flex-item">
                        <h2 class="mb-4">Pet grooming in Miami &<br>Fort Lauderdale</h2>
                        <p class="mb-4">
                            Our services is now in the great city of Miami! We’ve already begun providing our exemplary in-home pet grooming service to the wonderful pet owners here and we simply can’t wait to meet more.
                        </p> 
                        <p class="mb-4">
                            One thing that we have noticed with our time being here, is that many of the breeds we’ve seen so far could benefit immensely from a bit of Groomit magic!
                        </p>
                        <p class="mb-4">
                            Available in Miami Beach, South Beach, Aventura, Brickell, Key Biscayne, Coral Gables, Doral and Miami Design District.
                        </p>
                    </li>
                    <li class="flex-item">
			...
			<div class="col-lg-6 top col-sm-6 col-lg-pull-6 col-sm-pull-6 relative-pos text-center  mb-5">
                <img class="img-responsive mb-0" src="/desktop/img/miami-pricing.jpg" alt="Dog & Cat Grooming in Miami">            
            </div>
        </div>
                        ...
                        <div class="">
                            <div class="row" id="shampoo-services">
                                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1 col-sm-offset-0 col-sm-12">
                                    ...
                                    @php
                                        $dog = \App\Lib\Helper::get_dog_pricing(2);
                                        $cat = \App\Lib\Helper::get_cat_pricing(2);
                                    @endphp
