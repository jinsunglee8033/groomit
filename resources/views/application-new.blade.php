...
@section('content')
    ...
    <script type="text/javascript">
            ...
            validator = $('#frm_app').validate({
                ...
                rules: {
                    ...
                    groomer_exp_note: {
                        required: {
                            depends: function() {
                                return $('[name=groomer_exp]:checked').val() == 'Y'
                            }
                        }
                    },
                    groomer_edu_note: {
                        required: {
                            depends: function() {
                                return $('[name=groomer_edu]:checked').val() == 'Y'
                            }
                        }
                    },
                    special_area_note: {
                        required: {
                            depends: function() {
                                return $('[name=special_area]:checked').val() == 'Y'
                            }
                        }
                    },
                    reference_name: {
                        required: {
                            depends: function() {
                                return $('[name=have_reference]:checked').val() == 'Y'
                            }
                        }
                    },
                    reference_phone: {
                    ...
                    groomed_photo: {
                        required: {
                            depends: function() {
                                return $('[name=have_groomed_photo]:checked').val() == 'Y'
                            }
                        }
                    },
                    agree_to_bg_check: {
        ...
        function show_references() {
            if (
                !$('[name=groomer_exp]').valid() ||
                    ...
                    !$('[name=groom_per_month]').valid() ||
                    !$('[name=special_area]').valid() ||
                    !$('#special_area_note').valid()
        ...
        function show_background_check() {
            if (
                !$('[name=have_reference]').valid() ||
                    !$('#reference_name').valid() ||
                    !$('#reference_phone').valid() ||
                    !$('[name=have_groomed_photo]').valid() ||
                    !$('#groomed_photo').valid()
            ) {
                validator.focusInvalid();
                return;
    ...
    <section id="banner" class="banner-application"> <!-- #banner starts -->
      <video autoplay loop muted>
        <source src="videos/application-video.mp4" type="video/mp4">
        <!-- <source src="videos/groomit-home.ogg" type="video/ogg"> -->
        Your browser does not support the video tag.
      </video>
      <div class="container container-banner-info">
          <div class="col-lg-12" id="centerBannerHome">
              <h1>Welcome to the nations first<br>In-Home Pet Grooming Service App on Demand</h1>
              <p>Make money on your own schedule - Be your own boss</p>
          </div>
      </div>
    </section> <!-- #banner ends -->
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12 text-center col-sm-12 col-xs-12 ">
                <div class=""></div>
                <h3><span class="work">WHY WORK WITH US</span></h3>
            </div>
          </div>
          <div class="row">
              ...
              <div class="col-lg-8 col-lg-offset-2 ">
                  ...
                  <div class="work-us">
                      <div class="col-lg-6 col-sm-6 col-xs-12">
                          <ul>
                            <li><span><img class="img-responsive" src="images/icon-own-schedule.png" alt="Create your own schedule"/></span>Create your own schedule</li>
                            <li><span><img class="img-responsive" src="images/icon-insurance-provided.png" alt="Insurance provided"/></span>Insurance provided</li>
                          </ul>
                      </div>
                      <div class="col-lg-6 col-sm-6 col-xs-12">
                          <ul>
                            <li><span><img class="img-responsive" src="images/icon-more-money.png" alt="Earn more money with less hassle"/></span>Earn more money with less hassle</li>
                            <li><span><img class="img-responsive" src="images/icon-keep-tips.png" alt="Keep 100% of all your tips"/></span>Keep 100% of all your tips</li>
                          </ul>
                      </div>
                  </div>
              </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-8 text-center col-lg-offset-2">
                      <h1 class="h1title text-center">Application</h3>
                    </div>
                    ...
                    <div class="col-lg-8 text-center col-lg-offset-2">
                        <div class="formSignUpApp">
                            <div class="field">
                                <div class="col-lg-6 col-md-6 col-sm-6 normal-first">
                                    ...
                                    <div class="normal-space">
                                        ...
                                        <div class="field fieldTitle">
                                            <div class="col-lg-12 normal-first">
                                                ...
                                                <div class="clearMobile">
                                                  <span><input class="newadded" name="" type="radio" {{ old('') == 'Y' ? 'checked' : '' }} value=""/>Dogs</span>
                                                  <span><input class="newadded" name="" type="radio" {{ old('') == 'Y' ? 'checked' : '' }} value=""/>Cats</span>
                                                  <span><input class="newadded" name="" type="radio" {{ old('') == 'Y' ? 'checked' : '' }} value=""/>Both</span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="field">
                                            <div class="col-lg-12 normal-first">
                                                ...
                                                <div class="clearMobile">
                                                  <span><input class="newadded" name="" type="radio" {{ old('') == 'Y' ? 'checked' : '' }} value=""/>Dog Grooming</span>
                                                  <span><input class="newadded" name="" type="radio" {{ old('') == 'Y' ? 'checked' : '' }} value=""/>Cat Grooming</span>
                                                  <span><input class="newadded" name="" type="radio" {{ old('') == 'Y' ? 'checked' : '' }} value=""/>Pet Safety / CPR</span>
                                                  <span><input class="newadded" name="" type="radio" {{ old('') == 'Y' ? 'checked' : '' }} value=""/>Breed Standards</span>
                                                  <span><input class="newadded" name="" type="radio" {{ old('') == 'Y' ? 'checked' : '' }} value=""/>Other</span>
                                                  <input type="text" name="groomer_edu_note" id="groomer_edu_note"  value="{{ old('groomer_edu_note') }}" required placeholder="If other, explain"/>
                                    ...
                                    <div class="normal-space">
                                        <div class="field fieldTitle">
                                            <div class="col-lg-12 normal-first">
                                                ...
                                                <div class="clearMobile">
                                                  <input class="newadded" type="text" id="" name="" value="{{ old('') }}" required placeholder="Explain"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="field fieldTitle">
                              ...
                              <div class="col-lg-10 col-lg-offset-1">
                                    ...
                                    <div class="field fieldTitle text-center">
                                        <div class="col-lg-12 normal-first">
                                            ...
                                            <div class="clearMobile">
                                              <span><input class="newadded" name="" type="radio" {{ old('') == 'Y' ? 'checked' : '' }} value="Y"/>Yes</span>
                                              <span><input class="newadded" name="" type="radio" {{ old('') == 'N' ? 'checked' : '' }} required aria-required="true" value="N"/>No</span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="panel-body text-center">
                                <div class="col-lg-10 col-lg-offset-1">
                                    <div class="normal-space">
                                        <div class="field fieldTitle">
                                            <div class="col-lg-12">
                                                <label>Your Profile Photo is a picture of your face that every customer will see. . It is important that this photo clear and visible so the customer is able to identify that you are the correct groomer.
