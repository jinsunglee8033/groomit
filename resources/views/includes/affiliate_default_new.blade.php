...
<!-- End Google Tag Manager -->
    ...
    <!--<link href="/css/affiliate_style.css?v=2.1.1" rel="stylesheet">-->
    ...
    <script src="/js/tooltip-validation/jquery-validate.bootstrap-tooltip.js"></script>
...
@include('includes.affiliate_header_new')
