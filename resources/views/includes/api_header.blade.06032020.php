...
<nav class="navbar navbar-inverse navbar-top">
    ...
    <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav">
            ...
            <li class="nav-item dropdown {{ (in_array($api, ['login', 'logout','login_3rd_party']) ?
            'active':
            '') }}">
            ...
            <li class="nav-item dropdown {{ (in_array($api, ['verify_email', 'verify_key', 'update_password']) ?
            'active':
            '') }}">
            ...
            <li class="nav-item dropdown {{ (in_array($api, ['profile_update', 'get_available_credit', 'get_referals' , 'update_device_token', 'profile_delete']) ?
            'active':
            '') }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="nav-item" tabindex="-1">
                        <a class="nav-link" href="/user/api/simulator?api=get_referals">Referal Code</a>
                    </li>
                    <li class="nav-item" tabindex="-1">
