          ...
          <div class="row">
            <div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
              ...
              <div id="recipient-info" style="display:none;">
                <h3>Who is this membership for?</h3>
                <br />
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group select-form-group">
    ...
    <div class="container">
      ...
      <div class="row hidden-xs">
        <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
          <div class="row">
              <div class="col-sm-4">
                <div class="icon-how"> <img src="/desktop/img/voucher-select.png" width="53" height="80" alt="Select the preferred membership" /> </div>
                <p class="how-desc">Select the preferred<br/><strong>membership</strong></p>
              </div>
              <!-- /col-6 -->
              <div class="col-sm-4">
                <div class="icon-how"> <img  src="/desktop/img/voucher-email.png" width="69" height="69" alt="We email your code." />
                </div>
                <p class="how-desc">We email<br/><strong>your code</strong></p>
              </div>
              <!-- /col-6 -->
              <div class="col-sm-4">
                <div class="icon-how"> <img src="/desktop/img/voucher-service.png" width="125" height="59" alt="Schedule a Groomit Appointment" /> </div>
      ...
      <div class="row visible-xs">
        ...
        <!-- /col-6 -->
        <div class="col-sm-3">
          <div class="icon-how"> <img  src="/desktop/img/voucher-email.png" width="69" height="69" alt="We email your
          code." /> </div>
          <p class="how-desc">We email<br/><strong>your code</strong></p>
        </div>
        <!-- /col-6 -->
  ...
  <div class="modal-dialog" role="document"> 
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" id="terms">
        <h4 class="modal-title text-center" id="termsLabel">Groomit Gift cards Terms and Conditions</h4>
        <div class="row">
...
<script type="text/javascript">
    function purchase() {
        ...
        myApp.showConfirm('You are about to buy Groomit Membership. Are you sure? ', function() {
            $.ajax({
                url: '/user/memberships/buy/process',
                data: {
                    _token: '{{ csrf_token() }}',
