...
@section('content')
        ...
        window.onload = function () {
            ...
            validator = $('#frm_app').validate({
                ...
                messages: {
                    ...
                    zip: {
                        regex: 'Please enter valid 5 digit ZIP code!!!'
                    }
                },
                tooltip_options: {
    ...
    <div id="application-main">
        ...
        <section id="benefits" class="log-out"> <!-- #benefits starts -->
            ...
            <form id="frm_app" name="frm_app" method="post" action="/pre-apply" enctype="multipart/form-data">
                {!! csrf_field() !!}
                <div class="container">

                    <div class="row">
                        <div class="col-lg-8 text-center col-lg-offset-2">
                        <h2 class="h2title text-center">Pre - Apply</h2>
                        </div>
                            ...
                            <div class="formSignUpApp">
                                <div class="field">
                                    <div class="col-lg-12 col-md-12 col-sm-12 normal-first">
                                        <input type="text" id="full_name" name="full_name" placeholder="Full Name" value="{{old('full_name') }}" required/>
                                    </div>
                                </div>
                                ...
                                <div class="field">
                                    <div class="col-lg-12 col-md-12 col-sm-12 normal-first">
                                        <input type="text" id="zip" name="zip" placeholder="zip" value="{{ old('zip') }}" required/>
                                    </div>
                                </div>

                                <div class="field">
                                    <div class="col-lg-12 col-md-12 col-sm-12 normal-first">
                                        <input type="text" id="referred_by" name="referred_by" placeholder="Referred By" value="{{ old('referred_by') }}" required/>
                                    </div>
                                </div>
