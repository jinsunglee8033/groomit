                    ...
                    <table width="600" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td width="366">
                                ...
                                <h3 style="text-align:center; color:black; font-size:20px; margin: 10px 0 20px 0; line-height:26px;font-weight: 700;">
                                    WELCOME TO GROOMIT!</h3>
                                <img src="{!! url('/') . $data['image'] !!}" width="340" height="183" alt="Gift Card" border="0" style="margin: 0 auto;" />

                                <p style="text-align:center;color: black;font-size:14px;margin: 30px 0 10px 0; line-height: 26px;">
                                    <strong>Dear {!! $data['name'] !!}, we have a gift for you from {!! $data['sender'] !!}</strong>
                                </p>
                                <p style="text-align:center;color: black;font-size:14px;margin: 0 0 30px 0; line-height: 26px;">
                                    <strong>Message:</strong> {!! $data['message'] !!}
                                </p>
                                <p style="text-align:center;color: black;font-size:14px;margin: 0; line-height: 26px;">
                                    <strong>YOUR GROOMIT CODE IS</strong>
                                </p>
                                <h3 style="text-align:center; color:black; font-size:20px; margin: 0 0 30px 0; line-height:26px;font-weight: 500;">
                                    {!! $data['promo_code'] !!}
                                </h3>
                            </td>
                            <td width="117">&nbsp;</td>
                    ...
                    <table width="600" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td width="548">
                                <table width="548" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="126" height="40" valign="top" align="center"><p style="text-align:center;"><img src="{{ url('/') . '/images/email/voucher-select.png' }}" width="21" height="32" alt="Gift Card" border="0" align="top" style="text-align:center;margin:0 auto;" /></p></td>
                                        <td width="6">&nbsp;</td>
                                        <td width="134" height="40" valign="top" align="center"><p style="text-align:center;"><img src="{{ url('/') . '/images/email/voucher-email.png' }}" width="28" height="28" alt="Gift Card" border="0" align="top" style="text-align:center;margin:0 auto;" /></p></td>
                                        <td width="6">&nbsp;</td>
                                        <td width="134" height="40" valign="top" align="center"><p style="text-align:center;"><img src="{{ url('/') . '/images/email/voucher-service.png' }}" width="51" height="24" alt="Gift Card" border="0" align="top" style="text-align:center;margin:0 auto;" /></p></td>
                                        <td width="6">&nbsp;</td>
                                        <td width="134" height="40" valign="top" align="center"><p style="text-align:center;"><img src="{{ url('/') . '/images/email/voucher-credit.png' }}" width="16" height="22" alt="Gift Card" border="0" align="top" style="text-align:center;margin:0 auto;" /></p></td>
                                    </tr>
                                </table>
                            </td>
                            <td width="26">&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td width="548">
                                <table width="548" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td width="126" valign="top"><p style="text-align:center;color:#231f20;font-size:14px;font-family: 'Open Sans', Helvetica, Arial, sans-serif;line-height: 110%;">Select the preferred<br/> E-Gift Card amount</p></td>
                                        <td width="6">&nbsp;</td>
                                        <td width="134" valign="top"><p style="text-align:center;color:#231f20;font-size:14px;font-family: 'Open Sans', Helvetica, Arial, sans-serif;line-height: 110%;">E-Gift Card will be emailed instantly to your recipient</p></td>
                                        <td width="6">&nbsp;</td>
                                        <td width="134" valign="top"><p style="text-align:center;color:#231f20;font-size:14px;font-family: 'Open Sans', Helvetica, Arial, sans-serif;line-height: 110%;">Redeem within Groomit App / Website at checkout</p></td>
                                        <td width="6">&nbsp;</td>
                                        <td width="134" valign="top"><p style="text-align:center;color:#231f20;font-size:14px;font-family: 'Open Sans', Helvetica, Arial, sans-serif;line-height: 110%;">Groomit Credits will be applied to your account</p></td>
                                    </tr>
                                </table>
                            </td>
                            <td width="26">&nbsp;</td>
