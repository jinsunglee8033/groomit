    ...
    <table bgcolor="#fff" width="600"  border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto;">
      <tbody>
        <tr>
          <td width="55">&nbsp;</td>
          <td width="490">
            <h3 style="text-align:center;color:#231f20;font-size:20px;">Appointment Reminder For Groomer</h3>

            <h4 style="text-align:center;color:#7e7e7e;font-size:15px;">You have an upcoming Groomit Appointment {!! $data['reminder_type'] !!} ({!! $data['accepted_date'] !!}) at {!! $data['address'] !!} with Groomer {!! $data['groomer'] !!}.</h4>
        ...
        <tr>
          ...
          <td width="35">
            <a href="https://www.facebook.com/groomitapp" target="_blank">
              <img src="{{ url('/') . '/images/email/facebook.png'}}" alt='Facebook' />
            </a>
          </td>
